...
func initFlags() {
	rootCmd.PersistentFlags().StringVarP(&executeFlag, "create", "c", "", "string=project_name, create project govel. if project_name is not specified, ecs_govel name will be used")
